...
\title{Seismic First Arrival Traveltime Inversion Harnessing
Physics Informed Neural Networks}
\turkishtitle{Fizik Bilgili Sinir Ağları Kullanarak Sismik \.{I}lk Var{\i}\c{s} Seyahat S\"{u}resi Ters \c{C}\"{o}z\"{u}m\"{u}}
...
\keywords{inverse problems, machine learning, traveltimes, PINN}
\anahtarklm{ters problemler, makine \"o\u{g}renmesi, seyahat s\"ureleri, FBSA }
%
% Abstract in English
%
\abstract{
...
\input{chap_01/intro}
\input{chap_01/motivation}
\input{chap_01/contribution}
\input{chap_02/intro}
\input{chap_02/traveltime_tomo}
\input{chap_02/pinn}
\input{chap_03/intro}
\input{chap_03/theory}
\input{chap_03/numerical_imp}
\input{chap_03/discussion}
\input{chap_04/intro}
\input{chap_04/area_and_data }
\input{chap_04/pinn_implementation} 
\input{chap_04/interpretation} 
\input{chap_05/intro}
%\input{chap_03/intro}
